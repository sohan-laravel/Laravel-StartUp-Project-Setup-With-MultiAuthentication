    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
         ...
         <div class="image float-left">
          <img src="{{ asset('backend/dist/img/admin.jpg') }}" class="img-circle elevation-2" width="30px" height="30px" alt="User Image">
        </div>

        <a class="nav-link float-right" style="cursor: pointer;" data-toggle="dropdown">
